...
export const WORKFLOW_STEPS: StepDefinition[] = [
  ...
  },
  {
    ...
    slug: "introduction",
    description: "Générer 2 introductions optimisées (PAS + PATT)",
    requiresValidation: true,
    validationType: "choose",
    maxTokens: 2048,
    temperature: 0.8,
    dependsOn: [7],
    userInstructions: "Choisissez entre PAS (Problème-Agitation-Solution) et PATT (Problème-Aperçu-Teasing-Transition). Les 200 premiers mots sont critiques pour le SEO.",
  },
  {
    number: 9,
    name: "Titres images",
